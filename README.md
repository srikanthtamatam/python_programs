...
3) To-Do-List : A simple to-do-list application is made using funtions, lists, match-case, conditional statements, loop.. this application allows users to track their     to-do-list tasks, add new task at desired position, delete a task, update a task.
